    ...
    public class EnemyAI : MonoBehaviour
    {
        ...
        public void Execute()
        {
            ...
            if (currSelectedSkill.TargetArea == TargetArea.Line)
            {
                ...
                float yDist = shortestPath[shPHelper1].gridLocation.y - targetHero.ActiveTile.gridLocation.y;
                float xDist = shortestPath[shPHelper1].gridLocation.x - targetHero.ActiveTile.gridLocation.x;
                float yDist2 = shortestPath[shPHelper2].gridLocation.y - targetHero.ActiveTile.gridLocation.y;
                float xDist2 = shortestPath[shPHelper2].gridLocation.x - targetHero.ActiveTile.gridLocation.x;
        ...
        public void MoveProcess(Entity thisUnit)
        {
            if (finalMovePath.Count > 0)
            {
                ...
                if (!detectedStealthHero)
                {
                    ...
                    PathfindingManager.Instance.MoveAlongPath(thisUnit, finalMovePath);
                }
            }
